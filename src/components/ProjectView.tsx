...
export default function ProjectView({
  ...
  return <div className="relative w-full min-h-[70vh] select-none pl-4 px-0">
      <div className="flex flex-col gap-3 w-full pb-10 md:pl-6 md:pr-6">
        ...
        {showProjectHeader && <div className="mb-6">
            ...
            {(project.client || project.year) && <div className="text-xs text-stone-400 mt-2 flex flex-row gap-3">
                {project.client && <span>
