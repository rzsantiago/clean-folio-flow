...
const About = ({ minimal }: { minimal?: boolean }) => (
  <div className={`max-w-xl mx-auto font-inter text-stone-700 ${minimal ? "" : "bg-white rounded-xl shadow"} md:ml-0 md:mr-auto px-4 md:px-4`}>
    <div className="w-full mb-6 rounded-xl overflow-hidden" style={{ height: 500, maxHeight: "60vw", minHeight: 240, background: "#eee" }}>
      <img
        src={PHOTO_URL}
        alt="Santiago Ruiz"
    ...
    <div className="text-xs space-y-4 pb-8">
      ...
      <p>
        Currently, I work part-time as a designer at <a href="https://sich.design" target="_blank" rel="noopener noreferrer" className="text-stone-700">sich.design</a> studio, where I lead and execute projects from their earliest stages — from research and ideation to the creation of all the technical materials required for final production. I collaborate closely with professionals from different fields to develop efficient, accelerated solutions with meaningful results. I also have advanced skills in 3D modeling and visualization, which I integrate seamlessly into my workflow.
      </p>
