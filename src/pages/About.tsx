...
const About = ({ minimal }: { minimal?: boolean }) => (
  <div className={`max-w-xl mx-auto font-helnow-regular text-stone-700 ${minimal ? "" : "bg-white rounded-xl shadow"} md:ml-0 md:mr-auto`}>
    <div className="w-full mb-8 rounded-xl overflow-hidden px-4 md:px-6" style={{ height: 500, maxHeight: "60vw", minHeight: 240, background: "#eee" }}>
      <img
        src={PHOTO_URL}
        alt="Santiago Ruiz"
    ...
    <div className="text-base space-y-4 pb-8 px-4 md:px-6">
      ...
      <div className="mt-6">
        <h2 className="font-helnow-regular text-lg mb-2">Academic Background</h2>
